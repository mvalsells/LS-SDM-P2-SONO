...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/SDM-P2-FaseA.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
${OBJECTDIR}/P2_FA_pic_8b_general.asm.o: P2_FA_pic_8b_general.asm.asm  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} dummy.d -e "${OBJECTDIR}/P2_FA_pic_8b_general.asm.err" $(SILENT) -c ${MP_AS} $(MP_EXTRA_AS_PRE) -d__DEBUG -d__MPLAB_DEBUGGER_PK3=1 -q -p$(MP_PROCESSOR_OPTION) -u  -l\\\"${OBJECTDIR}/P2_FA_pic_8b_general.asm.lst\\\" -e\\\"${OBJECTDIR}/P2_FA_pic_8b_general.asm.err\\\" $(ASM_OPTIONS)    -o\\\"${OBJECTDIR}/P2_FA_pic_8b_general.asm.o\\\" \\\"P2_FA_pic_8b_general.asm.asm\\\" 
...
${OBJECTDIR}/P2_FA_pic_8b_general.asm.o: P2_FA_pic_8b_general.asm.asm  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/P2_FA_pic_8b_general.asm.o.d 
	@${RM} ${OBJECTDIR}/P2_FA_pic_8b_general.asm.o 
	@${FIXDEPS} dummy.d -e "${OBJECTDIR}/P2_FA_pic_8b_general.asm.err" $(SILENT) -c ${MP_AS} $(MP_EXTRA_AS_PRE) -q -p$(MP_PROCESSOR_OPTION) -u  -l\\\"${OBJECTDIR}/P2_FA_pic_8b_general.asm.lst\\\" -e\\\"${OBJECTDIR}/P2_FA_pic_8b_general.asm.err\\\" $(ASM_OPTIONS)    -o\\\"${OBJECTDIR}/P2_FA_pic_8b_general.asm.o\\\" \\\"P2_FA_pic_8b_general.asm.asm\\\" 
	@${DEP_GEN} -d "${OBJECTDIR}/P2_FA_pic_8b_general.asm.o"
	@${FIXDEPS} "${OBJECTDIR}/P2_FA_pic_8b_general.asm.o.d" $(SILENT) -rsi ${MP_AS_DIR} -c18 
...
dist/${CND_CONF}/${IMAGE_TYPE}/SDM-P2-FaseA.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_LD} $(MP_EXTRA_LD_PRE)   -p$(MP_PROCESSOR_OPTION)  -w  -m"${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"   -z__MPLAB_BUILD=1  -odist/${CND_CONF}/${IMAGE_TYPE}/SDM-P2-FaseA.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
endif
